...
\begin{tad}
    ...
    \begin{tadOperations}{getElementCount}
        ...
        \tadOperation{getCount}{\tadParams{Statistics} × \tadParams{Element}}{\tadParams{\integer}}
        ...
        \tadOperationAvecPreconditions{getElement}{\tadParams{Statistics} × \tadParams{\integer}}{\tadParams{Element}}
    \end{tadOperations}
