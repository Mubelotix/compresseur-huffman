...
\begin{tad}
    ...
    \begin{tadOperations}{getElementCount}
        ...
        \tadOperation{getCount}{\tadParams{Statistics} x \tadParams{Element}}{\tadParams{\integer}}
        \tadOperation{incCount}{\tadParams{Statistics} x \tadParams{Element}}{\tadParams{Statistics}}
        \tadOperation{getCount}{\tadParams{Statistics} x \tadParams{Element}}{\tadParams{\integer}}
        \tadOperation{getElementCount}{\tadParams{Statistics}}{\tadParams{\integer}}
        \tadOperationAvecPreconditions{getElement}{\tadParams{Statistics} x \tadParams{\integer}}{\tadParams{Element}}
    \end{tadOperations}
