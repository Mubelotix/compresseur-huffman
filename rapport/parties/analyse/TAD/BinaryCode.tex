...
\begin{tad}
    ...
    \begin{tadOperations}{BinaryCode}
        ...
        \tadOperationAvecPreconditions{prefix}{BinaryCode × \naturel}{BinaryCode}
        \tadOperationAvecPreconditions{suffix}{BinaryCode × \naturel}{BinaryCode}
    ...
    \begin{tadPreconditions}{getBit}
        ...
        \tadPrecondition{prefix(BinaryCode,n)}{getLength(BinaryCode) >= n}
        \tadPrecondition{suffix(BinaryCode,n)}{getLength(BinaryCode) >= n}
